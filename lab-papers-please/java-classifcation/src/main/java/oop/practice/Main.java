...
public class Main {
  ...
  public static void main(@NotNull String[] args) throws IOException {
    ...
    if (args.length == 0) {
      ...
      System.out.println("Proceeding to display the menu...");
      List<Creature> creatures = List.of(); // Initialize an empty list for creatures
      List<Universe> universes = List.of(); // Initialize an empty list for universes
      UniverseManager universeManager = new UniverseManager();
      File inputFile = new File("input.json"); // Provide a placeholder input file

      // Call displayMenu with appropriate arguments
